...
My work fills this gap by highlighting the prevalence of such vulnerable high-level assumptions in service composition. Concretely, I argue that \textbf{vulnerable assumptions exist in a broad array of service composition scenarios; studying them not only helps us understand security risks but also informs future designs.}
I highlight vulnerable assumptions in three scenarios: email, Android, and cross-chain bridges.
