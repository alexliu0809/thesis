...
%% \alex{One way to avoid mentioning off-store is exlaining why we ignored apps distributed via google store (which is my current version); another option is to squeez in the off-store part somewhere in the intro; }
