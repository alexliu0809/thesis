...
% the extent that we identify outcomes (e.g., attacks) they are at the
...
% are not dealing with, nor do we attempt to analyze, data at the
...
% with respect to the principle of ``Justice'', we have no reason to
...
% Public Interest'', we are engaging with existing public data, we have
% documented our methods clearly and we are careful to limit our factual
% statements to those for which we have evidence.  As well, we have made
...
% in the interest of due diligence, we provide a more thorough
...
% defense.  Some of the unilateral transfers we have documented, if they
% were illegitimate (which we do not know), could also create liability
% for bridge operators, but we believe this potential harm is balanced
...
% dealerships, but we believe this is well-justified by the concordant
