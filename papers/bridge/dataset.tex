\begin{table*}[t]
  ...
  \bottomrule
\end{tabular}
  \caption{The blockchains \offlinetool supports and the cross-chain
    bridges that operate on them.  While a particular attack on a
    bridge involves two chains, we collect deposit and withdrawal
    transactions for a bridge on all chains that the bridge supports. Anyswap is also known as Multichain.\todo{format}}
...
\begin{table*}[t]
\centering
\begin{tabular}{p{2.8cm}rS[table-format=4.1]rrcrrr}
  \toprule
%  \textbf{Name} & \textbf{Date} & \makecell{\textbf{Amount} \\ (millions)} & \makecell{\textbf{TXNs}\\ \textbf{Analyzed}} & \makecell{\textbf{Reported Malilicious} \\ \textbf{TXNs Flagged}} & \makecell{\textbf{Unreported Malilicious} \\ \textbf{TXNs Flagged}} & \makecell{\textbf{Other TXNs} \\ \textbf{Flagged}} \\
  ...
  \midrule
    Ronin & Mar 2022 & 624.0\mil & 3.0\mil & 2                 & - &  -  & - & - \\ % 0
    PolyNetwork/2021 & Aug 2021 & 611.0\mil & 292\thou & 18    & - &  -  & 1 & - \\ % 1
    BSC Token Hub & Oct 2022 & 587.0\mil & 2.0\mil & 2         & - &  -  & - & - \\ % 0
    Wormhole & Jan 2022 & 360.0\mil & 642\thou & 1             & - &  -  & 2 & - \\ % 2
    Nomad & Aug 2022 & 152.0\mil & 37\thou & $^\dagger$962      & - &  -  & - & - \\ % 0
    Harmony & Jun 2022 & 100.0\mil & 336\thou & 15             & - &  -  & - & 43 \\ % 43
    HECO & Nov 2023 & 86.0\mil & 23\thou & 8                   & - &  -  & - & 73 \\ % 73
    Qubit & Jan 2022 & 80.0\mil & 260 & 16                     & - & 114 & - & - \\ % 114
    Anyswap & Jul 2021 & 7.9\mil & 3.4\mil & 4                & 24 &  -  & 806 & 7 \\ % 2
    PolyNetwork/2023 & Jun 2023 & 4.4\mil & 290\thou & 136     & - &  -  & 1 & 27 \\ %28
    Chainswap & Jul 2021 & 4.4\mil & 53\thou & $^*$1136        & - &  15 & 4 & - \\ % 17
    Meter & Feb 2022 & 4.3\mil & 14\thou & $^\dagger$5          & - &  -  & - & - \\ \midrule % 0
    Total  &          & 2.6\bil & 10.1\mil & 2,305             & 24 &  129 & 814 & 150 \\
% 43+73+7+27=150
    \bottomrule
    % Chainswap (07-02) & 2021-07 & 4.4 & & & & \\ \hline (worth noting. still from bridge's user)
    % Omni\alex{will be removed} & 2022-09 & 0.5 & & & Many & \\ \hline
...
\caption{List of top attacks on cross-chain bridges in the retrospective
  ...
  identified by \offlinetool.\todo{format}
  %% and we report the number of violating transactions
...
%In this section we demonstrate the effectiveness of using the balance
...
%For our retrospective analysis, we first describe how we selected the
%bridges and blockchains for our study, and how we collect bridge
...
% where we discuss scope
% we exclude  attacks as well as swap bridges.
...
%%   discussing the invariants (something like we ignore them for the
...
%% widely-used and well-developed blockchains. While we could explore
...
% CoinMarketCap), and offer good API support. In total, we support 25
% blockchains.  
...
%%   bridge, we audit every contract it has deployed on every blockchain
%%   we support, which is typically much broader than the set of the
...
\begin{figure}[t]
  ...
  \caption{The lifetime of the bridges in our retrospective study.
...
%Since the attacks we consider involve smart contracts, the smart
...
For each bridge, we collected deposit and withdrawal transactions for
...
%Since that bridge was not attacked and is outside our scope, we only
...
%% transactions, and thus we focus on deposit and withdraw transactions
%% on Binance Smart Chain.  \geoff{not sure why we're mentioning this
%%   distinction...is this an explanation for why we do not support
