...
I demonstrate that for a bridge to operate safely, a variety of assumptions must hold true, including the integrity of the bridge's smart contracts and the security of the cryptographic keys used to manage assets.
However, these assumptions often fail to hold, as writing secure smart contracts is notoriously difficult and keeping infrastructure secure is an ongoing challenge. Indeed, 
a variety of attacks have exploited these failed assumptions to steal billions of dollars' worth of assets from bridges.
I study these attacks and design a simple yet effective mechanism that accounts for vulnerable assumptions and mitigates a broad range of attacks.
