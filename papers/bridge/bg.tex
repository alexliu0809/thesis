...
% In this section, I start by providing an overview of blockchain technology. I then describe how cross-chain bridges work followed by the threat model I consider in this paper.
% In this section
...
deposit details against receipt details---both that the deposit was not already
...
% In this section, I begin by providing an example of how a typical cross-chain transaction works. I then discuss the different variants of cross-chain bridges. 
...
% Beyond the typical cross-chain transaction described above, there are different ways to implement a cross-chain bridge. I discuss the following variants:
