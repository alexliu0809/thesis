    ...
    \centering
{
    ...
    \fbox{\includegraphics[clip,width=0.98\columnwidth]{fig/ss_outlook_not_rejecting.png}}
}
...
via email about the forwarding setup.}\todo{format}  Moreover, as we demonstrate in three
