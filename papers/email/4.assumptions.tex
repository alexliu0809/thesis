    ...
    \centering
{
    ...
    \fbox{\includegraphics[clip,width=\columnwidth]{fig/ss_outlook_not_rejecting.png}}
}
...
\begin{table*}[t]
  ...
  %  & \multicolumn{3}{c}{\textbf{Attacks}} \\
    ...
    \midrule
   \multirow{2}{*}{\S~\ref{subsec:attack_open_forwarding}} & Domains with the forwarding domain's SPF information & \multirow{2}{*}{Six providers including Outlook and iCloud} & \multirow{2}{*}{Any recipient} \\
