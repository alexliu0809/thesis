...
% Indeed, through our large-scale measurements, we identify a diverse set of email forwarding mechanisms, assumptions and features.
...
A core issue we highlight in this chapter is the ability to forward spoofed email messages to arbitrary recipients, a critical element in each
...
% First, we recommend that all mail service providers disable \emph{open
...
%deliverability of forwarded email messages, we recommend implementing
