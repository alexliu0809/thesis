...
represent services developed by three different parties. 
Oftentimes, these assumptions do not always hold --- a service may assume how users or another service will behave, which is not always the case in the presence of adversaries.
These assumptions ultimately lead to security vulnerabilities. Then, I show how these vulnerabilities can be exploited to bypass email authentication
