...
\label{chap:swordbox}
\input{includes/email/1.intro.tex}
\input{includes/email/2.background.tex}
\input{includes/email/3.forward_in_the_wild.tex}
\input{includes/email/4.assumptions.tex}
\input{includes/email/5.attacks.tex}
\input{includes/email/6.disclosure.tex}
\input{includes/email/7.mitigation_and_discussion.tex}
\input{includes/email/8.conclusion.tex}
